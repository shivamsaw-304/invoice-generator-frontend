...
const InvoiceForm = () => {
    ...
    // Handle change for sections (company, billing, shipping, invoice, account)
    ...
    return (
        <div className="invoiceform container py-4">
            ...
            <div className="mb-4">
                ...
                <button className="btn btn-outline-primary" type="button" onClick={addItem}>Add Items</button>
            </div>
                ...
                <div className="row g-3">
                    ...
                    <div className="col-md-4">
                        <input
                            type="text"
                            className="form-control"
                            placeholder="Branch code /IFSC code"
            ...
            <div className="mb-4">
                ...
                <div className="d-flex justify-content-end">
                    <div className="w-100 w-md-50">
                        ...
                        <div className="d-flex justify-content-between">
                            <label htmlFor="taxRate" className="me-2">TaxRate %</label>
                            <input
                                type="number"
                                id="taxRate"
